	...
	public function datatable() {	
        ...
        return Datatables::of($data)
			->addColumn('action', function ($data) {
                ...
                return "<a class='btn-action btn btn-primary btn-view' href='".$url."' title='View'><i class='fa fa-eye'></i></a> <a class='btn-action btn btn-info' href='".$url_edit."' title='Edit'><i class='fa fa-edit'></i></a> <button data-url='".$url."' onclick='deleteData(this)' class='btn-action btn btn-danger' title='Delete'><i class='fas fa-trash'></i></button>";
            })			
            ->rawColumns(['action'])
            ->make(true);		
	}
