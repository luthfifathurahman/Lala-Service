...
<div class="content-wrapper">	
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Purchase Order  - <?=$mode;?></h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
			...
			<div class="col-md-12">
				...
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">Purchase Order - <?=$mode;?></h3>
					</div>
                    <!-- form start -->
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?=url('/backend/purchase-order')?>" class="btn btn-warning float-right">Cancel</a>
                    </div>
                    {{ Form::close() }}
                </div>
            </div>
